<div class="w-full min-h-[calc(100vh-70px)] flex justify-center items-center py-5">
    <section class="max-w-5xl px-8 py-4 bg-white/5 backdrop-blur-md border-[1px] border-white/60 rounded-lg shadow-md dark:bg-gray-800 ">
        <div class="container h-full px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
            <div class="wf-ull lg:w-1/2">
                ...
                <h1 class="mt-3 text-2xl font-semibold text-white md:text-3xl">Pagina no encontrada</h1>
                <p class="mt-4 text-white">Lo sentimos, no hemos podido encontrar la página que buscas. Aquí tienes algunos enlaces que podrían ser de ayuda:</p>
            ...
            <div class="relative w-full mt-12 lg:w-1/2 lg:mt-0">
                <img class="m-auto max-h-32" src="/images/logo.png" alt="">
